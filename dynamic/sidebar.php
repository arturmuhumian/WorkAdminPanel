<div class="col-md-2 left-side">
    ...
    <div class="dropdown hide-on-small" style="visibility:hidden;">
    ...
    <div class="dropdown hide-on-small" style="visibility:hidden;">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1" style="visibility:hidden;">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
            <li><a href="#">Something else here</a></li>
            <li role="separator" class="divider"></li>
    ...
    <div class="dropdown hide-on-small"  style="visibility:hidden;">
        ...
        <ul class="dropdown-menu hide-on-small" aria-labelledby="dropdownMenu1" style="visibility:hidden;">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
            <li><a href="#">Something else here</a></li>
            <li role="separator" class="divider"></li>
